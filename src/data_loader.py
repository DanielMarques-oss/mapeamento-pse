...
def load_data():
    ...
    atividades_pse = pd.read_csv("data/RelAtvColetivaMB.csv", skiprows=9, encoding='ISO-8859-1', sep=';').iloc[:-2]
    parti_pse = pd.read_csv("data/RelPartiAtvColetivaMB.csv", skiprows=9, encoding='ISO-8859-1', sep=';').iloc[:-2]
